...
VL_INLINE_OPT QData VGame_Console_TOP::_change_request_1(VGame_Console_TOP__Syms* __restrict vlSymsp) {
    ...
    VL_DEBUG_IF( if(__req && ((vlSymsp->TOP__Game_Console_TOP__DOT__u_ppu__DOT__u_bg1.__PVT__rgb_convert_end ^ vlTOPp->__Vchglast__TOP__Game_Console_TOP__DOT__u_ppu__DOT__u_bg1__rgb_convert_end))) VL_DBG_MSGF("        CHANGE: ../src/../src/Pixel_Reader.sv:121: rgb_convert_end\n"); );
    VL_DEBUG_IF( if(__req && ((vlSymsp->TOP__Game_Console_TOP__DOT__u_ppu__DOT__u_bg2.__PVT__rgb_convert_end ^ vlTOPp->__Vchglast__TOP__Game_Console_TOP__DOT__u_ppu__DOT__u_bg2__rgb_convert_end))) VL_DBG_MSGF("        CHANGE: ../src/../src/Pixel_Reader.sv:121: rgb_convert_end\n"); );
    VL_DEBUG_IF( if(__req && ((vlSymsp->TOP__Game_Console_TOP__DOT__u_ppu__DOT__u_ch1.__PVT__rgb_convert_end ^ vlTOPp->__Vchglast__TOP__Game_Console_TOP__DOT__u_ppu__DOT__u_ch1__rgb_convert_end))) VL_DBG_MSGF("        CHANGE: ../src/../src/Pixel_Reader.sv:121: rgb_convert_end\n"); );
    VL_DEBUG_IF( if(__req && ((vlSymsp->TOP__Game_Console_TOP__DOT__u_ppu__DOT__u_ch2.__PVT__rgb_convert_end ^ vlTOPp->__Vchglast__TOP__Game_Console_TOP__DOT__u_ppu__DOT__u_ch2__rgb_convert_end))) VL_DBG_MSGF("        CHANGE: ../src/../src/Pixel_Reader.sv:121: rgb_convert_end\n"); );
    VL_DEBUG_IF( if(__req && ((vlSymsp->TOP__Game_Console_TOP__DOT__u_ppu__DOT__u_ch3.__PVT__rgb_convert_end ^ vlTOPp->__Vchglast__TOP__Game_Console_TOP__DOT__u_ppu__DOT__u_ch3__rgb_convert_end))) VL_DBG_MSGF("        CHANGE: ../src/../src/Pixel_Reader.sv:121: rgb_convert_end\n"); );
    VL_DEBUG_IF( if(__req && ((vlSymsp->TOP__Game_Console_TOP__DOT__u_ppu__DOT__u_ch4.__PVT__rgb_convert_end ^ vlTOPp->__Vchglast__TOP__Game_Console_TOP__DOT__u_ppu__DOT__u_ch4__rgb_convert_end))) VL_DBG_MSGF("        CHANGE: ../src/../src/Pixel_Reader.sv:121: rgb_convert_end\n"); );
    VL_DEBUG_IF( if(__req && ((vlSymsp->TOP__Game_Console_TOP__DOT__u_ppu__DOT__u_sc.__PVT__rgb_convert_end ^ vlTOPp->__Vchglast__TOP__Game_Console_TOP__DOT__u_ppu__DOT__u_sc__rgb_convert_end))) VL_DBG_MSGF("        CHANGE: ../src/../src/Pixel_Reader.sv:121: rgb_convert_end\n"); );
    VL_DEBUG_IF( if(__req && ((vlSymsp->TOP__Game_Console_TOP__DOT__u_ppu__DOT__u_st.__PVT__rgb_convert_end ^ vlTOPp->__Vchglast__TOP__Game_Console_TOP__DOT__u_ppu__DOT__u_st__rgb_convert_end))) VL_DBG_MSGF("        CHANGE: ../src/../src/Pixel_Reader.sv:121: rgb_convert_end\n"); );
    VL_DEBUG_IF( if(__req && ((vlSymsp->TOP__Game_Console_TOP__DOT__u_ppu__DOT__u_un1.__PVT__rgb_convert_end ^ vlTOPp->__Vchglast__TOP__Game_Console_TOP__DOT__u_ppu__DOT__u_un1__rgb_convert_end))) VL_DBG_MSGF("        CHANGE: ../src/../src/Pixel_Reader.sv:121: rgb_convert_end\n"); );
    VL_DEBUG_IF( if(__req && ((vlSymsp->TOP__Game_Console_TOP__DOT__u_ppu__DOT__u_un2.__PVT__rgb_convert_end ^ vlTOPp->__Vchglast__TOP__Game_Console_TOP__DOT__u_ppu__DOT__u_un2__rgb_convert_end))) VL_DBG_MSGF("        CHANGE: ../src/../src/Pixel_Reader.sv:121: rgb_convert_end\n"); );
    // Final
