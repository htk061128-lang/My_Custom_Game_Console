...
VL_INLINE_OPT void Vpixel_fifo_top_Decompresser::_combo__TOP__pixel_fifo_top__DOT__u_decomp_bg1__52(Vpixel_fifo_top__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+        Vpixel_fifo_top_Decompresser::_combo__TOP__pixel_fifo_top__DOT__u_decomp_bg1__52\n"); );
...
VL_INLINE_OPT void Vpixel_fifo_top_Decompresser::_sequent__TOP__pixel_fifo_top__DOT__u_decomp_bg2__40(Vpixel_fifo_top__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+        Vpixel_fifo_top_Decompresser::_sequent__TOP__pixel_fifo_top__DOT__u_decomp_bg2__40\n"); );
    Vpixel_fifo_top* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
...
VL_INLINE_OPT void Vpixel_fifo_top_Decompresser::_combo__TOP__pixel_fifo_top__DOT__u_decomp_bg2__50(Vpixel_fifo_top__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+        Vpixel_fifo_top_Decompresser::_combo__TOP__pixel_fifo_top__DOT__u_decomp_bg2__50\n"); );
    Vpixel_fifo_top* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
...
VL_INLINE_OPT void Vpixel_fifo_top_Decompresser::_combo__TOP__pixel_fifo_top__DOT__u_decomp_bg2__51(Vpixel_fifo_top__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+        Vpixel_fifo_top_Decompresser::_combo__TOP__pixel_fifo_top__DOT__u_decomp_bg2__51\n"); );
    Vpixel_fifo_top* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    this->__PVT__compressed_fifo_r_data = 0ULL;
    if (this->__PVT__compressed_fifo_r_state) {
